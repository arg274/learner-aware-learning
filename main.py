...
class SlideExtractor:
    ...
    def find_closest_slide(self, frame: np.ndarray) -> int:
        ...
        for idx, ref_slide in enumerate(self.reference_slides):
            ...
            combined_score = 0.6 * hist_similarity + 0.4 * edge_similarity
...
def main():
    """Example usage."""
    # Configuration
    video_path = "data/MITRES6_012S18_L11-05_300k.mp4"  # Path to your video file
    pdf_path = "data/L11.pdf"          # Path to your PDF with slides
